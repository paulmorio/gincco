...
for _ in tqdm(range(25)):
    # Randomly structured computational graph specification
    ...
    x, y, genes, index_to_genesymbol, genesymbol_to_index = load_metabric(data_path, "Grade", "scale")
    ...
    with open("metabric_random_pcomplex.csv", "a") as fh:
