"""
Script for experimenting constrained network via network identified protein complexes/functional modules
on the tcga dataset
"""
...
# ## Induce the subgraph of tcga relevant genes on the string network
# ## if necessary
# if not (os.path.exists('data/tcga_all_edge.txt')):
...
#     tcga_network = get_generic_string_overlap_network(genes, 
#         "data/network_data/string/9606_protein_info.txt", 
#         "data/network_data/string/9606_protein_links.txt")

#     nx.write_edgelist(tcga_network, "tcga_all_edge.txt", data=False)
...
netclust_path = "data/clusterings/tcga_mcode_clusters.txt"
...
print("########\n##.. Done full course FCMLP for base case on raw gene expression \n#########")
